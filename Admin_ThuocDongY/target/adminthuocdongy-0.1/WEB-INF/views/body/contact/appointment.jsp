...
<script type="text/javascript" src="resources/js/ajax/contact/appointment.js"></script>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row" style="justify-content: space-between">
                                    <div class="form-group col-lg-8">
                                        <label class="col-form-label">Địa chỉ<span
                                                style="color: red"></span></label>
                                        <input id="input-address" class="form-control here" type="text" disabled>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label class="col-form-label">Tình trạng<span
                                                style="color: red">*</span></label>
                                        <select id="input-status" class="form-control here">
                                            <option value="1">Mới</option>
                                            <option value="2">Đã liên hệ</option>
                                            <option value="3">Đã khám</option>
                                        </select>
                                ...
                                <div class="row" style="justify-content: space-between">
                                    <div class="form-group col-lg-12">
                                        <label class="col-form-label">Lý do khám<span
                                                style="color: red"></span></label>
                                        <textarea id="input-reason" class="form-control here" type="text" rows="4" disabled>
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row" style="justify-content: space-between">
                                    <div class="form-group col-lg-6">
                                        <label class="col-form-label">Cơ sở<span
                                                style="color: red"></span></label>
                                        <input id="input-branch" class="form-control here" type="text" disabled>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label class="col-form-label">Bác sĩ<span
                                                style="color: red"></span></label>
                                        <input id="input-doctor" class="form-control here" type="text" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 10px 10px">
                <div class="row col-lg-12" style="justify-content: center">
                    <h4 class="modal-title font-weight-normal"><i class="fas fa-trash-alt"></i>&nbsp;Xóa lịch khám
                    </h4>
                </div>
            </div>
            <div class="modal-body">
