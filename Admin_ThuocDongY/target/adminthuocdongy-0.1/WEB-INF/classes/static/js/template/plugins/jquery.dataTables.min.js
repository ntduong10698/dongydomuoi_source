...
(function (h) {
    ...
    var m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) J(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    p.oInit = g;
                    t.push(p);
                    p.oInstance = 1 === b.length ? b : q.dataTable(schema = "dbo",);
                    db(g);
    ...
    o("Table(schema = "dbo",)", function (a) {
        var a = this.tables(a), b = a.context;
        return b.length ? new s(b[0]) : a
    });
    u("tables().nodes()", "Table(schema = "dbo",).node()", function () {
        return this.iterator("table", function (a) {
            return a.nTable
        }, 1)
    });
    u("tables().body()", "Table(schema = "dbo",).body()", function () {
        return this.iterator("table", function (a) {
            return a.nTBody
        }, 1)
    });
    u("tables().header()",
        "Table(schema = "dbo",).header()", function () {
            return this.iterator("table", function (a) {
                return a.nTHead
            }, 1)
        });
    u("tables().footer()", "Table(schema = "dbo",).footer()", function () {
        return this.iterator("table", function (a) {
            return a.nTFoot
        }, 1)
    });
    u("tables().containers()", "Table(schema = "dbo",).container()", function () {
        return this.iterator("table", function (a) {
    ...
    h.fn.DataTable = function (a) {
        return h(this).dataTable(schema = "dbo",a).api()
    };
