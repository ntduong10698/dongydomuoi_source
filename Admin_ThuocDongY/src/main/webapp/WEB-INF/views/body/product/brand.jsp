...
<script type="text/javascript" src="resources/js/ajax/product/brand.js"></script>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Thông tin thương hiệu</h5>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row" style="justify-content: center">
                            <div class="col-lg-12">
                                <label class="col-form-label">Tên thương hiệu<span
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row" style="justify-content: space-between">
                                    <div class="form-group col-lg-6">
                                        <label class="col-form-label">Tải lên ảnh thương hiệu<span
                                                style="color: red"> *</span></label>
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 10px 10px">
                <div class="row col-lg-12" style="justify-content: center">
                    <h4 class="modal-title font-weight-normal"><i class="fas fa-trash-alt"></i>&nbsp;Xóa thương hiệu
                    </h4>
                </div>
            </div>
            <div class="modal-body">
