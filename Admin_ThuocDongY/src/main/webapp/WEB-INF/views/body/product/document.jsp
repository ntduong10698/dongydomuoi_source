...
<script type="text/javascript" src="resources/js/ajax/product/document.js"></script>
    ...
    <div class="card">
        <div class="table-responsive" style="overflow-x:auto;overflow-y: auto">
            ...
            <div class="row text-md-left d-flex justify-content-md-start"
                 style="width: 100%; justify-content: center; margin-top: 10px;margin-bottom: 10px">
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <div class="row" style="justify-content: space-between">
                            <div class="form-group col-lg-12">
                                <label class="col-form-label">Tên tài liệu<span
                        ...
                        <div class="row" style="justify-content: space-between">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="row"
                                    ...
                                    <img id="file-preview" src="resources/image/upload-file.png"
                                         style="max-width: 150px" alt="Tài liệu"
                            ...
                            <div class="form-group col-lg-6">
                                <label class="col-form-label">Mô tả<span
                                        style="color: red"></span></label>
                                <textarea id="input-description" rows="8"
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 10px 10px">
                <div class="row col-lg-12" style="justify-content: center">
                    <h4 class="modal-title font-weight-normal"><i class="fas fa-trash-alt"></i>&nbsp;Xóa tài liệu
                    </h4>
                </div>
            </div>
            <div class="modal-body">
