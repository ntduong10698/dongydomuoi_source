...
<script type="text/javascript" src="resources/js/ajax/product/category.js"></script>
    ...
    <div class="card">
        <div class="table-responsive" style="overflow-x:auto;overflow-y: auto">
            ...
            <div class="row text-md-left d-flex justify-content-md-start"
                ...
                <div class="search-by-table col-lg-4 " style="">
                        ...
                        <div class="row" style="justify-content: center">
                            <div class="col-lg-12">
                                <div class="row" style="justify-content: space-between">
                                    ...
                                    <div class="form-group col-lg-3">
                                        <label class="col-form-label">Thuộc danh mục<span
                                                style="color: red"></span></label>
                                        <select class="form-control" id="input-parent-category">
                                        </select>
                                    </div>
