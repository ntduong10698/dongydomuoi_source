...
<script type="text/javascript" src="resources/js/ajax/marketing/popup.js"></script>
...
<div id="popup-modal" class="modal fade" data-backdrop="static" role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Thông tin Popup</h5>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row" style="justify-content: space-between">
                                    <div class="form-group col-lg-4">
                                        <label class="col-form-label">Tên popup<span
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row" >
                                    <div class="form-group col-lg-6">
                                        <label class="col-form-label">Tải lên ảnh popup<span
                                                style="color: red"> *</span></label>
                                        ...
                                        <div id="div-img-image" class="row"
                                            ...
                                            <img id="img-preview" src="resources/image/camera2.png"
                                                 style="max-width: 300px" alt="Hình ảnh"
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding: 10px 10px">
                <div class="row col-lg-12" style="justify-content: center">
                    <h4 class="modal-title font-weight-normal"><i class="fas fa-trash-alt"></i>&nbsp;Xóa popup
                    </h4>
                </div>
            </div>
            <div class="modal-body">
